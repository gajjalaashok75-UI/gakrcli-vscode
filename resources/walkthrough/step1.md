...
Prefer working in the terminal? Run **GakrCLI: Open in Terminal** from the Command Palette, or enable it permanently in Settings under `gakrcliCode.useTerminal`.
