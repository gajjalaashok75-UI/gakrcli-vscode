...
To start a fresh conversation, click the **New Chat** button. You can also enable the **Ctrl+N** / **Cmd+N** shortcut in settings (`gakrcli.enableNewConversationShortcut`).
