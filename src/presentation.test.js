...
function createStatus(overrides = {}) {
  return {
    ...
    terminalName: 'Gakr',
    shimEnabled: false,
    workspaceFolder: '/workspace/gakr',
    workspaceSourceLabel: 'active editor workspace',
    launchCwd: '/workspace/gakr',
      ...
      rows: [
        {
          ...
          summary: 'gakr',
          detail: '/workspace/gakr · active editor workspace',
        },
        {
          key: 'profileStatus',
...
test('buildControlCenterViewModel keeps launch command only in summary cards', () => {
  ...
  assert.deepEqual(viewModel.summaryCards.find(card => card.key === 'launchCommand'), {
    ...
    value: 'gakrcli --project-aware',
    detail: 'Integrated terminal: Gakr',
  });
