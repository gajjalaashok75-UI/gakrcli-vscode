...
<body>
  <div class="chat-header">
    <div class="brand"><span class="brand-accent">GakrCLI</span></div>
  ...
  <div class="messages" id="messages">
    <div class="welcome" id="welcomeScreen">
      <div class="welcome-title"><span class="accent">GakrCLI</span></div>
  ...
  <div class="input-area">
    <textarea id="chatInput" placeholder="Message GakrCLI..." rows="1"></textarea>
