/**
 * ProcessManager — spawns GakrCLI in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The gakrcli binary (e.g. 'gakrcli')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'gakrcli';
